    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Tambah Data Alamat Pengiriman</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('admin.shippings.index')}}" class="btn btn-dark mb-3">Kembali</a>
                <form action="{{route('admin.shippings.shipping_address.store')}}" method="post">
                    @csrf
                    @method('POST')
                    ...
                    <input type="text" id="province" name="province" class="form-control" placeholder="Provinsi"
                        aria-label="Provinsi" aria-describedby="basic-addon1">
