    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Data Payment</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('admin.payments.create')}}" class="btn btn-dark mb-3">Tambah Metode Pembayaran +</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning"
                                        href="{{route('admin.payments.edit', $payment->id)}}">Edit</a>
