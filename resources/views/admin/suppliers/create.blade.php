        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.suppliers.store')}}" method="post">
                    ...
                    <input type="number" id="phone" name="phone" class="form-control" placeholder="No. Telpon"
                        aria-label="No. Telpon" aria-describedby="basic-addon1">
