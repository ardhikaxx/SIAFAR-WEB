...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('admin.discounts.create')}}" class="btn btn-dark mb-3">Tambah Diskon Obat +</a>
                <form class="d-flex gap-5 flex-row align-items-end pb-3" action="{{ route('admin.discounts.index') }}"
                    method="GET">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning"
                                        href="{{route('admin.discounts.edit', $discount->id)}}">Edit</a>
