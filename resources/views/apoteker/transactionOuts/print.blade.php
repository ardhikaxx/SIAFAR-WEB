...
<title>Cetak Transaksi Keluar</title>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="text-center d-flex flex-column justify-content-center">
                <h1>Apotek Cendana.</h1>
                <h3 class="card-title text-bold">Data Detail Transaksi Keluar</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{$transactionOut->shipping_method->name}}, Rp.
                            {{number_format($transactionOut->shipping_method->price, 0, ',', '.')}}
                        </td>
                    </tr>
                    <tr>
