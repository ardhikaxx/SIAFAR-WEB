    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <form action="{{ route('apoteker.transactionOuts.index') }}" method="get" class="d-flex"
                ...
                <form action="{{ route('apoteker.transactionOuts.index') }}" method="GET"
                    ...
                    <tbody>
                        @foreach ($transactionOuts as $transactionOut)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('apoteker.transactionOuts.show', $transactionOut->id)}}"
