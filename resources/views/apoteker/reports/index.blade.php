...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="d-flex gap-5 flex-row align-items-end" action="{{ route('apoteker.reports.reportIn') }}"
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="d-flex gap-5 flex-column align-items-end"
                    action="{{ route('apoteker.reports.reportOut') }}" method="GET" target="_blank">
                    @csrf
