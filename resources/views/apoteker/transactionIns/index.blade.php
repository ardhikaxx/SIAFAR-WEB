...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="d-flex gap-5 flex-row align-items-end"
                    action="{{ route('apoteker.transactionIns.index') }}" method="GET">
                    @csrf
                    ...
                    <tbody>
                        @foreach ($transactionIns as $transactionIn)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('apoteker.transactionIns.show', $transactionIn->id)}}"
