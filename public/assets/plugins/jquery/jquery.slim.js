...
(function (global, factory) {
        ...
        (function (window) {
            ...
            function Sizzle(selector, context, results, seed) {
                var m,
                    ...
                    groups,
                    newSelector,
                    newContext = context && context.adminDocument,
            ...
            isXML = Sizzle.isXML = function (elem) {
                var namespace = elem && elem.namespaceURI,
                    docElem =
                        elem && (elem.adminDocument || elem).documentElement;
            ...
            setDocument = Sizzle.setDocument = function (node) {
                var hasCompare,
                    subWindow,
                    doc = node ? node.adminDocument || node : preferredDoc;
	...
	---------------------------------------------------------------------- */
                ...
                sortOrder = hasCompare
                    ? function (a, b) {
                          ...
                          // eslint-disable-next-line eqeqeq
                          compare =
                              (a.adminDocument || a) == (b.adminDocument || b)
            ...
            Sizzle.contains = function (context, elem) {
                ...
                // two documents; shallow comparisons work.
                // eslint-disable-next-line eqeqeq
                if ((context.adminDocument || context) != document) {
                    setDocument(context);
                }
            ...
            Sizzle.attr = function (elem, name) {
                ...
                // two documents; shallow comparisons work.
                // eslint-disable-next-line eqeqeq
                if ((elem.adminDocument || elem) != document) {
                    setDocument(elem);
                }
    ...
    var acceptData = function (admin) {
        ...
        //  - Object
        //    - Any
        return admin.nodeType === 1 || admin.nodeType === 9 || !+admin.nodeType;
    };
    ...
    Data.prototype = {
        cache: function (admin) {
            // Check if the admin object already has a cache
            var value = admin[this.expando];
            ...
            if (!value) {
                ...
                if (acceptData(admin)) {
                    ...
                    if (admin.nodeType) {
                        admin[this.expando] = value;

                        // Otherwise secure it in a non-enumerable property
                        // configurable must be true to allow the property to be
                        // deleted when data is removed
                    } else {
                        Object.defineProperty(admin, this.expando, {
                            value: value,
                            configurable: true,
                        });
                    }
        ...
        set: function (admin, data, value) {
            var prop,
                cache = this.cache(admin);

            // Handle: [ admin, key, value ] args
            // Always use camelCase key (gh-2257)
            if (typeof data === "string") {
                cache[camelCase(data)] = value;

                // Handle: [ admin, { properties } ] args
            } else {
        ...
        get: function (admin, key) {
            return key === undefined
                ? this.cache(admin)
                : // Always use camelCase key (gh-2257)
                  admin[this.expando] && admin[this.expando][camelCase(key)];
        },
        access: function (admin, key, value) {
            ...
            //   2. A key and value
            //
            this.set(admin, key, value);

            // Since the "set" path can have two possible entry points
            // return the expected data based on which path was taken[*]
            return value !== undefined ? value : key;
        },
        remove: function (admin, key) {
            var i,
                cache = admin[this.expando];
            ...
            if (key === undefined || jQuery.isEmptyObject(cache)) {
                ...
                if (admin.nodeType) {
                    admin[this.expando] = undefined;
                } else {
                    delete admin[this.expando];
                }
            }
        },
        hasData: function (admin) {
            var cache = admin[this.expando];
    ...
    var isAttached = function (elem) {
            return jQuery.contains(elem.adminDocument, elem);
        },
    ...
    if (documentElement.getRootNode) {
        isAttached = function (elem) {
            return (
                jQuery.contains(elem.adminDocument, elem) ||
                elem.getRootNode(composed) === elem.adminDocument
            );
        };
    }
    ...
    function domManip(collection, args, callback, ignored) {
        ...
        if (l) {
            ...
            if (first || ignored) {
                ...
                if (hasScripts) {
                    doc = scripts[scripts.length - 1].adminDocument;
    ...
    var getStyles = function (elem) {
        ...
        var view = elem.adminDocument.defaultView;
    ...
    jQuery.extend(jQuery.event, {
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            // Bubble up to document, then to window; watch for a global adminDocument var (#9724)
            if (!onlyHandlers && !special.noBubble && !isWindow(elem)) {
                ...
                if (tmp === (elem.adminDocument || document)) {
                    eventPath.push(
        ...
        jQuery.each(
            ...
            function (orig, fix) {
                ...
                jQuery.event.special[fix] = {
                    setup: function () {
                        // Handle: regular nodes (via `this.adminDocument`), window
                        // (via `this.document`) & document (via `this`).
                        var doc = this.adminDocument || this.document || this,
    ...
    jQuery.fn.extend({
        wrapAll: function (html) {
            ...
            if (this[0]) {
                ...
                wrap = jQuery(html, this[0].adminDocument).eq(0).clone(true);
    ...
    jQuery.fn.extend({
        ...
        offset: function (options) {
            ...
            win = elem.adminDocument.defaultView;
            return {
