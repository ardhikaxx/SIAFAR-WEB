...
!(function (e, t) {
    ...
    var p = (function (n) {
        ...
        (i = se.isXML =
            function (e) {
                var t = e && e.namespaceURI,
                    n = e && (e.adminDocument || e).documentElement;
        ...
        (se.contains = function (e, t) {
            return (e.adminDocument || e) != T && C(e), y(e, t);
        }),
        (se.attr = function (e, t) {
            (e.adminDocument || e) != T && C(e);
            ...
            if (r[1]) {
                if (
                    ...
                    E.merge(
                        ...
                        E.parseHTML(
                            r[1],
                            t && t.nodeType ? t.adminDocument || t : w,
                            !0
                        )
                    ),
    ...
    var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        ie = function (e) {
            return E.contains(e.adminDocument, e);
        },
        oe = { composed: !0 };
    re.getRootNode &&
        (ie = function (e) {
            return (
                E.contains(e.adminDocument, e) ||
                e.getRootNode(oe) === e.adminDocument
            );
        });
    var ae = function (e, t) {
        return (
    ...
    function qe(n, r, i, o) {
        ...
        if (
            f &&
            ((t = (e = me(r, n[0].adminDocument, !1, n, o)).firstChild),
            ...
            if (s)
                for (
                    l = a[a.length - 1].adminDocument, E.map(a, Le), c = 0;
                    c < s;
                    c++
                )
                    (u = a[c]),
    ...
    var Pe = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"),
        He = function (e) {
            var t = e.adminDocument.defaultView;
    ...
    E.extend(E.event, {
        ...
        m.focusin ||
            E.each({ focus: "focusin", blur: "focusout" }, function (n, r) {
                ...
                E.event.special[r] = {
                    setup: function () {
                        var e = this.adminDocument || this.document || this,
                            t = Y.access(e, r);
        ...
        E.fn.extend({
            wrapAll: function (e) {
                ...
                return (
                    this[0] &&
                        (b(e) && (e = e.call(this[0])),
                        (t = E(e, this[0].adminDocument).eq(0).clone(!0)),
