...
!(function (t) {
            ...
            _createWidget: function (t, e) {
                (e = V(e || this.defaultElement || this)[0]),
                    ...
                    e !== this &&
                        ...
                        (this.document = V(
                            e.style ? e.adminDocument : e.document || e
                        )),
                        (this.window = V(
    ...
    function U(t) {
        var e,
            i,
            s = t.adminDocument.defaultView
                ? t.adminDocument.defaultView.getComputedStyle(t, null)
                : t.currentStyle,
            n = {};
    ...
    (V.ui.keyCode = {
        ...
        (V.fn.scrollParent = function (t) {
            ...
            return "fixed" !== e && t.length
                ? t
                : V(this[0].adminDocument || document);
        }),
        V.extend(V.expr.pseudos, {
            tabbable: function (t) {
            ...
            drag: function (t, e, i) {
                for (
                    ...
                    (l =
                        ...
                        c + p < m ||
                        !V.contains(
                            i.snapElements[v].item.adminDocument,
