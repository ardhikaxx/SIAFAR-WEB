...
(function (factory) {
    ...
    (function () {
        ...
        function getElementStyles(elem) {
            var key,
                len,
                style = elem.adminDocument.defaultView
                    ? elem.adminDocument.defaultView.getComputedStyle(
                          elem,
                          null
                      )
                    : elem.currentStyle,
        ...
        drag: function (event, ui, inst) {
            ...
            for (i = inst.snapElements.length - 1; i >= 0; i--) {
                ...
                if (
                    ...
                    y1 > b + d ||
                    !$.contains(
                        inst.snapElements[i].item.adminDocument,
