...
(function (global, factory) {
    ...
    var hasSelection = window.getSelection
        ...
        : function (te) {
              var range;
              try {
                  range = te.adminDocument.selection.createRange();
              } catch (e) {}
    ...
    function leftButtonStartDrag(cm, event, pos, behavior) {
        ...
        var dragEnd = operation(cm, function (e) {
            ...
            off(display.wrapper.adminDocument, "mouseup", dragEnd);
            off(display.wrapper.adminDocument, "mousemove", mouseMove);
            ...
            if (!moved) {
                ...
                if ((webkit && !safari) || (ie && ie_version == 9)) {
                    setTimeout(function () {
                        display.wrapper.adminDocument.body.focus({
                            preventScroll: true,
                        });
                        display.input.focus();
                    }, 20);
        ...
        on(display.wrapper.adminDocument, "mouseup", dragEnd);
        on(display.wrapper.adminDocument, "mousemove", mouseMove);
    ...
    function leftButtonSelect(cm, event, start, behavior) {
        ...
        function done(e) {
            ...
            off(display.wrapper.adminDocument, "mousemove", move);
            off(display.wrapper.adminDocument, "mouseup", up);
        ...
        on(display.wrapper.adminDocument, "mousemove", move);
        on(display.wrapper.adminDocument, "mouseup", up);
    }
    ...
    ContentEditableInput.prototype.getSelection = function () {
        return this.cm.display.wrapper.adminDocument.getSelection();
    };
