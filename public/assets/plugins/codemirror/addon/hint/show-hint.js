...
(function (mod) {
    ...
    function Widget(completion, data) {
        ...
        var widget = this,
            cm = completion.cm;
        var adminDocument = cm.getInputField().adminDocument;
        var parentWindow =
            adminDocument.defaultView || adminDocument.parentWindow;

        var hints = (this.hints = adminDocument.createElement("ul"));
        ...
        for (var i = 0; i < completions.length; ++i) {
            var elt = hints.appendChild(adminDocument.createElement("li")),
                cur = completions[i];
            var className =
                HINT_ELEMENT_CLASS +
        ...
        var container = completion.options.container || adminDocument.body;
        ...
        var offsetLeft = 0,
            offsetTop = 0;
        if (container !== adminDocument.body) {
            ...
            var bodyPosition = adminDocument.body.getBoundingClientRect();
            offsetLeft =
        ...
        var winW =
            ...
            Math.max(
                adminDocument.body.offsetWidth,
                adminDocument.documentElement.offsetWidth
            );
        var winH =
            parentWindow.innerHeight ||
            Math.max(
                adminDocument.body.offsetHeight,
                adminDocument.documentElement.offsetHeight
            );
            ...
            (this.onScroll = function () {
                ...
                var point =
                    ...
                    (parentWindow.pageYOffset ||
                        (adminDocument.documentElement || adminDocument.body)
                            .scrollTop);
