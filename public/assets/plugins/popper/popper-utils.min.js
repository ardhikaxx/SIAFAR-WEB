 ...
 */ function a(a, b) {
    ...
    const c = a.adminDocument.defaultView,
    ...
    return e && "BODY" !== e && "HTML" !== e
        ? -1 !== ["TH", "TD", "TABLE"].indexOf(d.nodeName) &&
          "static" === a(d, "position")
            ...
            : d
        : b
        ? b.adminDocument.documentElement
...
function m(a, b = "top") {
    const c = "top" === b ? "scrollTop" : "scrollLeft",
        d = a.nodeName;
    if ("BODY" === d || "HTML" === d) {
        const b = a.adminDocument.documentElement,
            d = a.adminDocument.scrollingElement || b;
        return d[c];
    }
    return a[c];
}
...
function t(b) {
    ...
    const d = {
        ...
        e = "HTML" === b.nodeName ? q(b.adminDocument) : {},
...
function v(a, b = !1) {
    var c = Math.max;
    const d = a.adminDocument.documentElement,
        e = u(a, d),
...
function y(a, e, f, g, h = !1) {
    ...
    if ("viewport" === g) i = v(j, h);
        ...
        "scrollParent" === g
            ? ((d = c(b(e))),
              "BODY" === d.nodeName && (d = a.adminDocument.documentElement))
            : "window" === g
            ? (d = a.adminDocument.documentElement)
            : (d = g);
        const f = u(d, j, h);
        if ("HTML" === d.nodeName && !w(j)) {
            const { height: b, width: c } = q(a.adminDocument);
...
function I(a) {
    let b;
    if ("HTML" === a.nodeName) {
        const { width: c, height: d } = q(a.adminDocument);
...
function J(a) {
    const b = a.adminDocument.defaultView,
...
function X(a, b, d, e) {
    const f = "BODY" === a.nodeName,
        g = f ? a.adminDocument.defaultView : a;
