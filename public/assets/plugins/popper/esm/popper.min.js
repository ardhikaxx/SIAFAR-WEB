...
function s(e, t) {
    ...
    var o = e.adminDocument.defaultView,
...
function w(e) {
    var t =
        ...
        n = e.nodeName;
    if ("BODY" === n || "HTML" === n) {
        var i = e.adminDocument.documentElement,
            r = e.adminDocument.scrollingElement || i;
        return r[o];
    }
    return e[o];
}
...
function D(e) {
    ...
    var i = {
        ...
        r = "HTML" === e.nodeName ? v(e.adminDocument) : {},
...
function P(e) {
    var t = Math.max,
        ...
        n = e.adminDocument.documentElement,
        i = N(e, n),
...
function B(e, t, o, n) {
    ...
    if ("viewport" === n) r = P(p, i);
        ...
        "scrollParent" === n
            ? ((s = a(d(t))),
              "BODY" === s.nodeName && (s = e.adminDocument.documentElement))
            : "window" === n
            ? (s = e.adminDocument.documentElement)
            : (s = n);
        var f = N(s, p, i);
        if ("HTML" === s.nodeName && !k(p)) {
            var m = v(e.adminDocument),
                h = m.height,
                c = m.width;
