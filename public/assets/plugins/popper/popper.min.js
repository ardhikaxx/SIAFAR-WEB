...
function d(e, t) {
    ...
    const o = e.adminDocument.defaultView,
    ...
    return n && "BODY" !== n && "HTML" !== n
        ? -1 !== ["TH", "TD", "TABLE"].indexOf(o.nodeName) &&
          "static" === d(o, "position")
            ...
            : o
        : e
        ? e.adminDocument.documentElement
...
function w(e, t = "top") {
    const o = "top" === t ? "scrollTop" : "scrollLeft",
        n = e.nodeName;
    if ("BODY" === n || "HTML" === n) {
        const t = e.adminDocument.documentElement,
            n = e.adminDocument.scrollingElement || t;
        return n[o];
    }
    return e[o];
}
...
function S(e) {
    ...
    const o = {
        ...
        n = "HTML" === e.nodeName ? v(e.adminDocument) : {},
...
function D(e, t = !1) {
    var o = Math.max;
    const n = e.adminDocument.documentElement,
        i = T(e, n),
...
function P(e, t, o, n, i = !1) {
    ...
    if ("viewport" === n) r = D(p, i);
        ...
        "scrollParent" === n
            ? ((o = f(s(t))),
              "BODY" === o.nodeName && (o = e.adminDocument.documentElement))
            : "window" === n
            ? (o = e.adminDocument.documentElement)
            : (o = n);
        const d = T(o, p, i);
        if ("HTML" === o.nodeName && !C(p)) {
            const { height: t, width: o } = v(e.adminDocument);
...
function k(e) {
    const t = e.adminDocument.defaultView,
...
function K(e) {
    const t = e.adminDocument;
    return t ? t.defaultView : window;
}
function q(e, t, o, n) {
    const i = "BODY" === e.nodeName,
        r = i ? e.adminDocument.defaultView : e;
