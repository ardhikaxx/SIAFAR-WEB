...
!(function (t, e) {
    ...
    function K(t, e) {
        ...
        var n = t.adminDocument.defaultView.getComputedStyle(t, null);
        return e ? n[e] : n;
    }
    function X(t) {
        ...
        return i && "BODY" !== i && "HTML" !== i
            ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) &&
              "static" === K(n, "position")
                ...
                : n
            : t
            ? t.adminDocument.documentElement
    ...
    function ot(t) {
        var e =
            ...
            i = t.nodeName;
        if ("BODY" === i || "HTML" === i) {
            var o = t.adminDocument.documentElement,
                r = t.adminDocument.scrollingElement || o;
            return r[n];
        }
        return t[n];
    }
    ...
    function pt(t) {
        ...
        var o = {
            ...
            r = "HTML" === t.nodeName ? lt(t.adminDocument) : {},
    ...
    function gt(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            n = t.adminDocument.documentElement,
            i = mt(t, n),
        ...
        if ("viewport" === i) r = gt(a, o);
            ...
            "scrollParent" === i
                ? "BODY" === (s = G(X(e))).nodeName &&
                  (s = t.adminDocument.documentElement)
                : (s = "window" === i ? t.adminDocument.documentElement : i);
            var l = mt(s, a, o);
            if ("HTML" !== s.nodeName || _t(a)) r = l;
            else {
                var u = lt(t.adminDocument),
                    f = u.height,
                    d = u.width;
    ...
    function Tt(t) {
        var e = t.adminDocument.defaultView.getComputedStyle(t),
    ...
    function xt(t) {
        var e = t.adminDocument;
        return e ? e.defaultView : window;
    }
    function jt(t, e, n, i) {
        var o = "BODY" === t.nodeName,
            r = o ? t.adminDocument.defaultView : t;
