 ...
 */ (function (a, b) {
        ...
        return e && "BODY" !== e && "HTML" !== e
            ? -1 !== ["TH", "TD", "TABLE"].indexOf(d.nodeName) &&
              "static" === b(d, "position")
                ...
                : d
            : a
            ? a.adminDocument.documentElement
    ...
    function q(a) {
        ...
        var g = {
            ...
            h = "HTML" === a.nodeName ? o(a.adminDocument) : {},
    ...
    function s(a) {
        var b = 1 < arguments.length && arguments[1] !== void 0 && arguments[1],
            c = a.adminDocument.documentElement,
            d = r(a, c),
    ...
    function v(a, b, f, g) {
        ...
        if ("viewport" === g) i = s(k, h);
            ...
            "scrollParent" === g
                ? ((l = d(c(b))),
                  "BODY" === l.nodeName &&
                      (l = a.adminDocument.documentElement))
                : "window" === g
                ? (l = a.adminDocument.documentElement)
                : (l = g);
            var m = r(l, k, h);
            if ("HTML" === l.nodeName && !t(k)) {
                var n = o(a.adminDocument),
                    p = n.height,
                    q = n.width;
