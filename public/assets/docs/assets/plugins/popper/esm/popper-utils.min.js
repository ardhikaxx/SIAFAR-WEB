 ...
 */ function a(a, b) {
    ...
    var c = a.adminDocument.defaultView,
...
function m(a) {
    var b =
        ...
        d = a.nodeName;
    if ("BODY" === d || "HTML" === d) {
        var e = a.adminDocument.documentElement,
            f = a.adminDocument.scrollingElement || e;
        return f[c];
    }
    return a[c];
}
...
function t(b) {
    ...
    var f = {
        ...
        g = "HTML" === b.nodeName ? q(b.adminDocument) : {},
...
function y(a, e, f, g) {
    ...
    if ("viewport" === g) i = v(j, h);
        ...
        "scrollParent" === g
            ? ((k = c(b(e))),
              "BODY" === k.nodeName && (k = a.adminDocument.documentElement))
            : "window" === g
            ? (k = a.adminDocument.documentElement)
            : (k = g);
        var m = u(k, j, h);
        if ("HTML" === k.nodeName && !w(j)) {
            var n = q(a.adminDocument),
                o = n.height,
                p = n.width;
...
function J(a) {
    var b = a.adminDocument.defaultView,
